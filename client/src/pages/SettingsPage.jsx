        ...
        <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Remind me to book meals</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Notify about payments</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-gray-900">Show Wallet Balance</h3>
                  <p className="text-sm text-gray-600">Display balance to other users</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
