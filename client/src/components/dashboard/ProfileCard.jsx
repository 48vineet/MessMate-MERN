...
const ProfileCard = ({ user }) => {
  ...
  const getMembershipBadge = () => {
    ...
    if (monthsDiff < 1)
      return { label: "New Member", color: "bg-blue-100 text-blue-800" };
    if (monthsDiff < 6)
      return { label: "Regular Member", color: "bg-green-100 text-green-800" };
    if (monthsDiff < 12)
      return { label: "Senior Member", color: "bg-purple-100 text-purple-800" };
