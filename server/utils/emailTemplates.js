...
// Resolve client URL from environment (prod-safe)
const getClientUrl = () => {
  const explicit = process.env.CLIENT_URL;
  if (explicit) return explicit;
  // On Vercel, VERCEL_URL is like my-app.vercel.app (no protocol)
  if (process.env.VERCEL_URL) return `https://${process.env.VERCEL_URL}`;
  // Render.com or generic HOST/PORT environments
  if (process.env.PUBLIC_CLIENT_URL) return process.env.PUBLIC_CLIENT_URL;
  return ""; // fallback to empty; callers should handle gracefully
};
  ...
  const content = `
      ...
      <div class="content">
        ...
        <p style="color: #666; line-height: 1.6; font-size: 16px;">
          Welcome to MessMate! Your account has been successfully created as a <strong>${
            user.role
          }</strong>.
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${CLIENT_URL}/login" class="button">
...
const bookingConfirmationTemplate = (booking, user, menuItem) => {
  const content = `
      ...
      <div class="content">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${CLIENT_URL}/bookings/${booking._id}" class="button">
...
const paymentConfirmationTemplate = (payment, user) => {
  const content = `
      ...
      <div class="content">
          ...
          <div class="booking-card">
            ...
            <p style="color: #6c757d; margin-bottom: 10px;">
              <strong>UPI Transaction ID:</strong> ${
                payment.upiDetails?.upiTransactionId || "Processing..."
              }
            </p>
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${CLIENT_URL}/wallet" class="button">
            View Wallet Balance
          </a>
        </div>
      </div>
      ...
      <div class="content">
        ...
        ${items
          ...
          <div class="booking-card">
            ...
            <div class="stats-grid">
              <div class="stat-item" style="background-color: ${
                item.currentStock === 0 ? "#f8d7da" : "#fff3cd"
              };">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${CLIENT_URL}/admin/inventory" class="button" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%);">
            Manage Inventory
          </a>
        </div>
      </div>
...
const dailySummaryTemplate = (data) => {
  const content = `
      ...
      <div class="content">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${CLIENT_URL}/admin/analytics" class="button">
